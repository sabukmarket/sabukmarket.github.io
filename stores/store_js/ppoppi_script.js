...
const marketStores = [
       {
        ...
        specialty: { ko: "(시세에 따라 가격이 변동됩니다.) 상추, 사과, 감자, 양파, 포도, 가지, 고추 등. <br>정선깐더덕 10,000원  정선곤드레 12,000원  <br>정선고사리 20,000원", 
...
function renderStores() {
    ...
    grid.innerHTML = filtered.map(store => {
        ...
        const mapNaverUrl = `https://naver.me/FbVXXBge`;
        const mapSearchUrl = `https://maps.app.goo.gl/PXuvJVwfLfpHNgpX9`;
